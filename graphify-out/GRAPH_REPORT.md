...
## Corpus Check
- 119 files · ~66,142 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1189 nodes · 1707 edges · 101 communities (83 shown, 18 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 96 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f428c35a`
...
Cohesion: 0.13
Nodes (15): dayjs, echarts, @element-plus/icons-vue, dependencies, axios, dayjs, echarts, @element-plus/icons-vue (+7 more)
...
Cohesion: 0.14
Nodes (9): appStore, chartLoading, DashboardCharts, hasApiKeys, isMobile, models, stats, todaySuccess (+1 more)
...
Cohesion: 0.17
Nodes (9): generateToken(), adminRoutes, { generateToken }, { initDatabase, getDatabase }, require, { generateToken }, { initDatabase, getDatabase }, require (+1 more)
...
Cohesion: 0.22
Nodes (9): scripts, build, dev, preview, test:landing, test:login-error-ui, test:mobile-bundle, test:user-actions (+1 more)
...
## Knowledge Gaps
- **614 isolated node(s):** `backup.sh script`, `name`, `version`, `main`, `start` (+609 more)

...
## Corpus Check
- 240 files · ~150,825 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2346 nodes · 3805 edges · 181 communities (149 shown, 32 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 280 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3e4a415f`
...
Cohesion: 0.06
Nodes (48): ANTHROPIC_LOG_CONTEXT, ANTHROPIC_RESPONSE_HEADERS, { apiKeyCanUseModel, listModelsForApiKey }, assertSupportedBillableInput(), { authenticateApiKey }, availableWalletBalance(), axios, billableTextProjection() (+40 more)
...
Cohesion: 0.15
Nodes (20): asObject(), { buildBillingDetailFromSnapshot }, buildLogFilters(), { createPostgresIdentity }, { createPostgresPaymentService }, createPostgresUserRouter(), csvField(), { defaultImageDisplayPricing } (+12 more)
...
Cohesion: 0.17
Nodes (8): createPostgresPaymentService(), { createPostgresPaymentService, signEasyPay }, { createSecretBox }, require, { createPostgresPaymentRouter }, { createPostgresPaymentService }, { createPostgresUserRouter }, require
...
### Community 170 - "extendRedisCooldown"
Cohesion: 0.31
...
### Community 173 - "postgres-admin-integration.test.js"
Cohesion: 0.25
...
### Community 176 - "postgres-admin.test.js"
Cohesion: 0.29
Nodes (3): { createPostgresAdminRouter }, { PostgresAdminCompatRepository }, require

### Community 177 - "worker-runtime.test.js"
Cohesion: 0.29

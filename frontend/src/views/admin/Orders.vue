...
function st(s){const m={pending:'warning',paid:'primary',credited:'success',cancelled:'info',abnormal:'danger'};return m[s]||'info'}
function sl(s){const m={pending:'待支付',paid:'已支付',credited:'已发放',cancelled:'已取消',abnormal:'异常'};return m[s]||s}
</script>
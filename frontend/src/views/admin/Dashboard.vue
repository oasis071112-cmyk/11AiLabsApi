...
<el-row :gutter="16">
<el-col :span="14"><el-card><template #header><div style="display:flex;align-items:center;gap:8px"><LineChart :size="18" color="#409eff"/> 7天调用趋势</div></template><div ref="trendChart" style="height:300px"></div></el-card></el-col>
...
<script setup>
import { ref, onMounted, nextTick } from 'vue';import api from '@/api';import * as echarts from 'echarts';import { LineChart, Trophy } from '@lucide/vue'

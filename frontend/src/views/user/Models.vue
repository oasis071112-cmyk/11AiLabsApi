...
<div class="dashboard">
  ...
  <div class="chart-card">
    <div class="chart-header"><Cpu :size="14" color="var(--primary)"/><span>模型列表与倍率</span></div>
    <div class="chart-body">
      <el-table :data="models">
        ...
        <el-table-column label="输入倍率" width="100" align="right"><template #default="{row}"><span style="font-weight:600;font-size:14px">×{{ row.display_multiplier_input }}</span></template></el-table-column>
        <el-table-column label="输出倍率" width="100" align="right"><template #default="{row}"><span style="font-weight:600;font-size:14px">×{{ row.display_multiplier_output }}</span></template></el-table-column>

...
@media(max-width:768px){.page-title{align-items:flex-start;gap:12px;margin-bottom:16px}.page-title h2{font-size:20px}.page-title p{line-height:1.45}.model-total{white-space:nowrap;padding-top:5px}.provider-switch,.type-switch{overflow-x:auto;scrollbar-width:none;padding-bottom:3px}.provider-switch::-webkit-scrollbar,.type-switch::-webkit-scrollbar{display:none}.provider-button{flex-shrink:0;padding:9px 12px;gap:12px}.type-switch button{flex-shrink:0}.model-grid{grid-template-columns:1fr;gap:11px}.model-card{padding:15px}.model-card:hover{transform:none}.model-head code{display:block;max-width:230px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.model-facts{margin:12px 0}.price-row{grid-template-columns:42px minmax(0,1fr) auto}}
</style>

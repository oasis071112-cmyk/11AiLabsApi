...
export const useAuthStore=defineStore('auth',()=>{
  ...
  async function login(u,p){const r=await api.post('/api/auth/login',{username:u,password:p});setToken(r.data.token);setUser(r.data.user);await checkAuth();return r.data}

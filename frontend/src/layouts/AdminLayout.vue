...
@media(min-width:769px) and (max-width:1180px){.admin-sidebar.compact{width:68px}.admin-sidebar.compact .admin-logo{padding:20px 0 14px}.admin-sidebar.compact .admin-logo img{height:28px;margin:0}.admin-sidebar.compact .admin-logo div{display:none}.admin-sidebar.compact .admin-menu{width:68px}.admin-sidebar.compact :deep(.el-menu-item){padding:0!important;justify-content:center}.admin-sidebar.compact :deep(.el-menu-item .el-icon){margin:0}}

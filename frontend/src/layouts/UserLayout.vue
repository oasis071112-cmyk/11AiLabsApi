...
.sidebar-logo{padding:20px 18px 15px}.sidebar-logo a{display:flex;align-items:center;gap:9px;text-decoration:none}.sidebar-logo img{height:32px}.sidebar-logo span{font-size:19px;font-weight:750;color:var(--text-primary);letter-spacing:-.03em}
.sidebar-nav{flex:1;padding:6px 10px 10px}.sidebar-link{display:flex;align-items:center;gap:11px;min-height:42px;padding:9px 11px;margin-bottom:3px;border-radius:9px;font-size:13px;font-weight:550;color:var(--text-secondary);text-decoration:none;transition:transform var(--transition),background var(--transition),color var(--transition)}.sidebar-link:hover{background:#f2f5ef;color:var(--text-primary);transform:translateX(2px)}.sidebar-link.active{background:#edf4ea;color:var(--primary);font-weight:650}
.sidebar-account{padding:0 10px 10px}.account-card{background:#fff;border:1px solid var(--border);border-radius:10px;padding:10px 11px;box-shadow:none}.account-name{display:flex;align-items:center;gap:9px;margin-bottom:8px}.account-name .el-avatar{background:var(--primary);flex-shrink:0}.account-name div{font-weight:650;font-size:13px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.account-actions{display:flex;gap:4px}.account-actions .el-button{flex:1;font-size:11px;margin:0;min-height:32px}.account-actions svg{margin-right:2px}
